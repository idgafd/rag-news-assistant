...
def main():
    ...
    mlflow.set_experiment("reranker-training")
    mlflow.start_run(run_name=run_name)
    mlflow.log_param("base_model", args.base_model)
    mlflow.log_param("epochs", args.epochs)
    mlflow.log_param("batch_size", args.batch_size)
    mlflow.log_param("num_negatives", args.num_negatives)
    mlflow.log_param("date_from", date_from)
    mlflow.log_param("date_to", date_to)
    mlflow.log_metric("num_samples", len(df))
    mlflow.log_metric("positive_labels", df["relevance"].sum())
    mlflow.log_metric("class_balance", df["relevance"].mean())
    ...
    mlflow.log_artifacts(output_path, artifact_path="model_artifact")
